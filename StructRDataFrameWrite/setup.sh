...
export LD_LIBRARY_PATH=$DIR_INST/lib:$LD_LIBRARY_PATHsour

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/cqt5de/Universal/StructRDataFrameWrite/build
...
export LD_LIBRARY_PATH=/sfs/gpfs/tardis/project/ptgroup/spinquest/share/2023-12-24/root/lib:$LD_LIBRARY_PATH

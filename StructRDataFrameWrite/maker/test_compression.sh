...
LOG_FILE="struct_rdataframe_compression_test_results.txt"
CSV_FILE="struct_rdataframe_compression_test_results.csv"
  ...
  do
    ...
    do
      ...
      do
        ...
        # Run the StructRDataFrameWrite and append both stdout and stderr to the log file
        result=$(./StructRDataFrameWrite $algo $level $basket_size $autoflush)
